                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        ...
                        <div className="mt-8">
                            ...
                            <InputText id="loginId" type="text" className="w-full md:w-30rem mb-5" style={{ padding: '1rem' }} autoComplete="off" />

                            <label htmlFor="password" className="block text-900 font-medium text-xl mb-2">
                                Password
                            </label>
                            <Password inputId="password" value={password} onChange={(e) => setPassword(e.target.value)} toggleMask className="w-full mb-5" inputClassName="w-full p-3 md:w-30rem" autoComplete="off"></Password>
